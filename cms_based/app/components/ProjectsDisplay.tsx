    ...
    return (
        <section id="projects" className="py-16 md:py-24 px-4 md:px-8 max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 gap-12 sm:gap-16">
                {/* Projects Grid */}
                {visibleProjects
                    .slice(0, isShowAll ? visibleProjects.length : 4)
                    .map((project, index) => {
                ...
                {/* View More Button */}
                {!isShowAll && visibleProjects.length > 4 && (
                    <div className="flex justify-center mt-8">
                        <button
                            onClick={() => setIsShowAll(true)}
                            className="px-8 py-3 bg-neutral-100 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 font-semibold rounded-xl hover:bg-neutral-200 dark:hover:bg-neutral-800 transition-colors"
                        >
                            View More Projects
                        </button>
                    </div>
